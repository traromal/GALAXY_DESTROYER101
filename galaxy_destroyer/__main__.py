...
from galaxy_destroyer.core.context import get_git_context
from galaxy_destroyer.core.memory import build_memory_prompt
...
class GalaxyCLI(GalaxyApp):
    ...
    async def _call_ai(self, question: str):
        ...
        try:
            ...
            system_context = await self.build_system_context()
            system_parts = ["You are a helpful AI assistant."]

            if "gitStatus" in system_context:
